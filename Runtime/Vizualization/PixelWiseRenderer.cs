...
{
    public class PixelWiseRenderer : GridRendererBase<int>, IIntGridRenderer
    {
        ...
        private readonly LinkedList<SpriteRenderer> inactivePixels = new();

        protected override void RenderGrid(Grid2D<int> grid)
        {
